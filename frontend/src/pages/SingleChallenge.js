      ...
      <div>
        ...
        {isAuth ? (
            <div className="divider">
              <p className="header title is-1 has-text-centered">
                {data.name}
              </p>
              <div className="columns is-centered">
                <div className="column is-8">
                  <div className="box">
                    <ReactMarkdown className="content">{data.description}</ReactMarkdown> {/* Render Markdown */}
                  </div>
                  <span className="divider has-text-centered">
                <a href={data.url} target="_blank" rel="noopener noreferrer">
                  <button className="button is-link">Go to Challenge</button>
                </a>
              </span>
                  <div className="field divider has-addons is-centered">
